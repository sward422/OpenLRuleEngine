...
public class RulesTest {
    ...
    @Test
    public void testHelloRuleStatusTrue() {
        HelloRule helloRule = new HelloRule("greetings",HELLO_RULE_ARGVALUES);
        Assert.assertTrue(helloRule.getRuleStatus());
    }

    @Test
    public void testHelloRuleStatusFalse() {
        HelloRule helloRule = new HelloRule("greetings",MEDICALPREM_RULE_ARGVALUES);
        Assert.assertFalse(helloRule.getRuleStatus());
    }
    ...
    @Test
    public void testMedicalPremiumRuleStatusTrue() {
        MedicalPremiumRule  medicalRule = new MedicalPremiumRule("medicalPremium",MEDICALPREM_RULE_ARGVALUES);
        Assert.assertTrue(medicalRule.getRuleStatus());
    }

    @Test
    public void testMedicalPremiumRuleStatusFalse() {
        MedicalPremiumRule  medicalRule = new MedicalPremiumRule("medicalPremium",HELLO_RULE_ARGVALUES);
        Assert.assertFalse(medicalRule.getRuleStatus());
    }
    ...
    @Test
    public void testTermLifeRuleStatusTrue() {
        TermLifeRule termRule = new TermLifeRule("termLifeRule",TERMLIFE_RULE_ARGVALUES);
         Assert.assertTrue(termRule.getRuleStatus());
    }

    @Test
    public void testTermLifeRuleStatusFalse() {
        TermLifeRule termRule = new TermLifeRule("termLifeRule",HELLO_RULE_ARGVALUES);
        Assert.assertFalse(termRule.getRuleStatus());
    }
}

...
public class RuleExecutorTest {
   ...
   public static final String   RULES_FILE_GOOD = "/Users/n0292928/EIS/OpenLData/SampleOpenlRules/TemplateRules_Multiple.xls";
   ...
   public void init() {
       ...
       helloRuleInvalidName     = new HelloRule(IRule.RULE_LIFE, HELLO_RULE_ARGVALUES );
    ...
    @Test
    public void testExecHelloRuleNoMatchNullResponseValue() {
        try {
            Object objResponse = ruleExec.executeRule(helloRuleNoMatch);
    ...
    @Test
    public void testExecHelloRuleInvalidName() {
        try {
    ...
    public void testExecTermLifeRuleIllegalArgException() {
        // Initial parm is numeric value for age...Supplying String should throw IllegalArgumentException
        // First Arg - Data Type = int not String...should be numeric...This arg value will throw exception
